...
export default function BlogPage() {
  ...
  return (
    <main className="max-w-6xl mx-auto px-6 pt-24 min-h-screen">
      <h1 className="font-pixel text-[clamp(2rem,5vw,4rem)] leading-tight mb-4">
        Feed
      </h1>
      ...
      <div className="border-t border-border/50">
        ...
        <div className="grid grid-cols-[100px_1fr_auto] gap-4 py-2 px-2 -mx-2">
          ...
          <span className="font-mono text-[10px] tracking-widest uppercase text-muted/60">Type</span>
        </div>
        {posts.map((post) => (
          <FeedRow
            key={post.slug}
