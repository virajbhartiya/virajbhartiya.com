            ...
            {organizations.map((org, index) => (
              ...
              >
                <a
                  ...
                  className={cn(
                    "group relative flex items-start gap-6 rounded-lg border p-6",
                ...
                >
                  <div className="relative shrink-0">
                    <div className="relative z-10 h-16 w-16 overflow-hidden rounded-xl border border-[var(--accent)]/20 bg-black/20 p-1">
                      <img
                        src={org.logo}
                        alt={`${org.name} logo`}
